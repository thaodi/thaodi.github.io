...
<header>
    ...
    <main>
        ...
        <br>
        <div class="head-name">
            <div class="line1"></div><span>THÔNG TIN KHUYẾN MÃI</span><div class="line2"></div>
        </div>
        <!--  -->
            ...
            <div class="container">
                <figure class="detail-banner">
                    <?php
                        ...
                        echo '<img src="./assets/img/poster/promotion/' . $poster1 . '" alt="Free guy poster" style="width:100%">';
                   ?>
                </figure>

                <div class="detail-content">
                    <?php echo '<h1 class="h1 detail-title">' . $promotion_name . '</h1>'; ?>
