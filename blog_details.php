...
<header>
    ...
    <main>
        ...
        <br>
        <div class="head-name">
            <div class="line1"></div><span>THÔNG TIN BLOG</span><div class="line2"></div>
        </div>
        <!--  -->
        <section class="detail">
            <div class="container">
                <figure class="detail-banner">
                    <?php
                        echo '<img src="./assets/img/poster/blog/' . $poster1 . '" alt="" style="width:100%">';
                   ?>
                </figure>

                <div class="detail-content">
                    <?php echo '<h1 class="h1 detail-title">' . $blog_name . '</h1>'; ?>
