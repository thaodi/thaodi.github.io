...
<head>
    ...
    <title>Commentary Details</title>
    <meta charset="UTF-8">
...
<header>
    ...
    <main>
        ...
        <br>
        <div class="head-name">
            <div class="line1"></div><span>THÔNG TIN BÀI VIẾT</span><div class="line2"></div>
        </div>
        <!--  -->
        <section class="detail">
            <div class="container">
                <figure class="detail-banner">
                    <?php
                        echo '<img src="./assets/img/poster/commentary/' . $poster1 . '" alt="Free guy movie poster" style="width:100%">';
                   ?>
                </figure>

                <div class="detail-content">
                    <?php echo '<h1 class="h1 detail-title">' . $commentary_name . '</h1>'; ?>
