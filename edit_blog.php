...
$sql = mysqli_query($conn, "SELECT * FROM `blog` WHERE `blog_id` = '$id'");
...
if (isset($_POST['update'])) {
    ...
    $sql_edit = "UPDATE `blog` SET `blog_name`='$blog_name',`poster`='$poster',`content`='$content' WHERE `blog_id`='$id'";
...
<body>
    ...
    <div class="container" style="width: 600px">
        <h2>Sửa thông tin Blog</h2>
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="pwd">Tên Blog:</label>
                <input type="text" class="form-control" value="<?php echo $blog_name; ?>" name="blog_name"
                    required>
            </div>
            <div class="form-group">
