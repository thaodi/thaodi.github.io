...
$sql = mysqli_query($conn, "SELECT * FROM `promotion` WHERE `promotion_id` = '$id'");
...
if (isset($_POST['update'])) {
    ...
    $sql_edit = "UPDATE `promotion` SET `promotion_name`='$promotion_name',`poster`='$poster',`content`='$content' WHERE `promotion_id`='$id'";
    ...
    <div class="container" style="width: 600px">
        ...
        <form action="" method="post" enctype="multipart/form-data" id="id_form">
            <div class="form-group">
                <label for="pwd">Tên khuyến mãi:</label>
                <input type="text" class="form-control" value="<?php echo $promotion_name; ?>" name="promotion_name"
                    required>
            </div>
            <div class="form-group">
