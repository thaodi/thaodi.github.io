...
<header>
    ...
    <main>
        <!-- ACTOR -->
        <div class="container all"><br>
            <div class="symbol-header">
                <a href="" style="text-decoration: none; color: red"><i class="fa-sharp fa-solid fa-person"></i> Diễn viên</a>
                <div class="line"></div>
            </div>
            <div class="grid-all" style="display:block">
            <?php
                        $sql = mysqli_query($conn, "SELECT * FROM `actor`");
                        while ($row = $sql->fetch_array(MYSQLI_ASSOC)) {
                            ...
                            $content = $row['content'];
                            echo
                                '<div class="cmt-card" id="' . $actor_id . '" style="width: 1000px; margin: 20px; display:flex">
                                    <img src="./assets/img/poster/actor/' . $poster . '" alt="Card image">
                                    <div style="display: block;margin: 20px">
                                    <a href="./actor_details.php?id=' . $actor_id . '" class="cmt-title">' . $actor_name .'</a>
                                    <p style="color: grey; font-size:15px; margin:10px">' . $content . ' </p>
                                    </div> 
                                </div>';
                        }
