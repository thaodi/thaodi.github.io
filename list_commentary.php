    ...
    <main>
        ...
        <div class="container all"><br>
            <div class="symbol-header">
                <a href="" style="text-decoration: none; color: red"><i class="fa-solid fa-comment"></i> Bình luận phim</a>
                <div class="line"></div>
            </div>
            <div class="grid-all">
                <?php
                ...
                while ($row = $sql->fetch_array(MYSQLI_ASSOC)) {
                    ...
                    echo
                        '<div class="cmt-list-card" id="' . $commentary_id . '">
                            <img src="./assets/img/poster/commentary/' . $poster . '" alt="Card image">
                            <a href="./commentary_details.php?id=' . $commentary_id . '" class="cmt-list-title">' . $commentary_name .'</a>
                        </div>';
                }
                ?>
            </div>
