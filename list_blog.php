    ...
    <main>
        ...
        <div class="container all"><br>
            <div class="symbol-header">
                <a href="" style="text-decoration: none; color: red"><i class="fa-brands fa-blogger"></i> Blog điện ảnh</a>
                <div class="line"></div>
            </div>
            <div class="grid-all">
                <?php
                ...
                while ($row = $sql->fetch_array(MYSQLI_ASSOC)) {
                    ...
                    echo
                        '<div class="blog-list-card" id="' . $blog_id . '">
                            <img src="./assets/img/poster/blog/' . $poster . '" alt="Card image">
                            <a href="./blog_details.php?id=' . $blog_id . '" class="blog-list-title">' . $blog_name .'</a>
                        </div>';
                }
                ?>
            </div>
